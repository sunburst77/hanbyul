...
(function( root, window, document, factory, undefined) {
    ...
    function initialise(containerSelector, options) {
        var isOK = options && new RegExp('([\\d\\w]{8}-){3}[\\d\\w]{8}|OPEN-SOURCE-GPLV3-LICENSE').test(options.licenseKey) || document.domain.indexOf('alvarotrigo.com') > -1;
        ...
        */
        function addVerticalNavigation(){
            ...
            for (var i = 0; i < $(SECTION_SEL).length; i++) {
                ...
                li += '<span class="name_navi">'+ toolname +'</span>' +'</li>';
            }
